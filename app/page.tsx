...
export default async function Home({
  ...
  // A user deactivated mid-session keeps a live JWT, and every gated route
  // bounces them back here — so render the form for them instead of sending
  // them on to a role home that would only bounce them again.
