...
function SelectContent({
  ...
  side = "bottom",
  sideOffset = 4,
  // Left edge with the trigger, opening downwards — not the macOS behaviour of
  // overlaying the trigger with the SELECTED item. That default only looks right
  // while the first option is chosen; pick any other and the list jumps upwards,
  // covering the field's own label and its neighbour.
  align = "start",
  alignOffset = 0,
